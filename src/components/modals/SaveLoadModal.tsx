                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <div className="text-xs text-gray-500 mb-1">Slot {slotId}</div>
                      {meta ? (
                        <div>
                      ...
                      {meta && !isConfirmingDelete && (
                        <>
                          ...
                          <button
                            ...
                            className="text-xs px-3 py-1.5 bg-gray-800 hover:bg-red-900 text-gray-500 hover:text-red-400 rounded border border-gray-700 hover:border-red-800 transition-colors whitespace-nowrap"
                          >
                            Delete
                          </button>
                        </>
                      ...
                      {meta && isConfirmingDelete && (
                        <div className="flex flex-col gap-1">
                          ...
                          <button
                            ...
                            className="text-xs px-3 py-1.5 bg-gray-800 hover:bg-gray-700 text-gray-400 rounded border border-gray-700 transition-colors"
                          >
                            Cancel
                          </button>
                        </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-800">
            {!confirmReset ? (
              <button
                ...
                className="w-full py-2 text-xs text-gray-600 hover:text-red-400 border border-gray-800 hover:border-red-900 rounded-lg transition-colors font-mono"
              >
              ...
              <div className="bg-red-950/40 border border-red-900/60 rounded-lg p-3">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-1.5 text-xs bg-gray-800 hover:bg-gray-700 text-gray-400 rounded border border-gray-700 transition-colors font-mono"
                  >
                    Cancel
                  </button>
                </div>
